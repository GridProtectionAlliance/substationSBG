--  ----------------------------------------------------------------------------------------------------
--  substationSBG Data Structures for SQL Server - Gbtc
--
...
--       Script is based on substationSBG.sql script created by James Ritchie Carroll.
...
USE [master]
GO
CREATE DATABASE [substationSBG];
GO
ALTER DATABASE [substationSBG] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [substationSBG] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [substationSBG] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [substationSBG] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [substationSBG] SET ARITHABORT OFF 
GO
ALTER DATABASE [substationSBG] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [substationSBG] SET AUTO_CREATE_STATISTICS ON 
GO
ALTER DATABASE [substationSBG] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [substationSBG] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [substationSBG] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [substationSBG] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [substationSBG] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [substationSBG] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [substationSBG] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [substationSBG] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [substationSBG] SET  ENABLE_BROKER 
GO
ALTER DATABASE [substationSBG] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [substationSBG] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [substationSBG] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [substationSBG] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [substationSBG] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [substationSBG] SET  READ_WRITE 
GO
ALTER DATABASE [substationSBG] SET RECOVERY SIMPLE 
GO
ALTER DATABASE [substationSBG] SET  MULTI_USER 
GO
ALTER DATABASE [substationSBG] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [substationSBG] SET DB_CHAINING OFF 
GO
-- The next three commented statements are used to create a user with access to the substationSBG database.
...
--GO
--CREATE ROLE [substationSBGManagerRole] AUTHORIZATION [dbo]
--GO
--EXEC sp_addrolemember N'substationSBGManagerRole', N'NewUser'
--GO
--EXEC sp_addrolemember N'db_datareader', N'substationSBGManagerRole'
--GO
--EXEC sp_addrolemember N'db_datawriter', N'substationSBGManagerRole'
--GO
