...
INSERT INTO Node(Name, CompanyID, Description, Settings, MenuType, MenuData, Master, LoadOrder, Enabled) 
	VALUES('Default', NULL, 'Default node', 'TimeSeriesDataServiceUrl=http://localhost:6152/historian;RemoteStatusServiceUrl={Server=localhost:8500;datapublisherport=6165};RealTimeStatisticServiceUrl=http://localhost:6052/historian', 
			'File', 'Menu.xml', 1, 0, 1);
