--  ----------------------------------------------------------------------------------------------------
--  substationSBG Data Structures for MySQL - Gbtc
--
...
CREATE DATABASE substationSBG CHARACTER SET = UTF8;
USE substationSBG;
...
-- GRANT SELECT, UPDATE, INSERT, DELETE ON substationSBG.* TO NewUser;
