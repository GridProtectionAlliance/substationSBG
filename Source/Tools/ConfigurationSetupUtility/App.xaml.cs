...
namespace ConfigurationSetupUtility
{
    ...
    public partial class App : Application
    {
        ...
        public const string ApplicationExe = "substationSBG.exe";
        public const string ApplicationConfig = "substationSBG.exe.config";
        public const string Manager = "substationSBGManager";
        public const string ManagerExe = "substationSBGManager.exe";
        public const string ManagerConfig = "substationSBGManager.exe.config";
        public const string BaseSqliteConfig = "substationSBG.db";
        public readonly static string SqliteConfigv2 = "substationSBG" + DatabaseVersionSuffix + ".db";
        public const string SqliteSampleData = "substationSBG-SampleDataSet.db";
        public const string SqliteInitialData = "substationSBG-InitialDataSet.db";
