...
namespace ConfigurationSetupUtility.Screens
{
    ...
    public partial class UserAccountCredentialsSetupScreen : UserControl, IScreen
    {
        ...
        public bool UserInputIsValid
        {
            get
            {
                if (!CheckCurrentUserAuthentication())
                {
                    ...
                    {
                        // Define default values for database passwords, but attempt to load custom settings from substationSBG or manager config files
        ...
        private void RadioButtonWindowsAuthentication_Checked(object sender, RoutedEventArgs e)
        {
            ...
            MessageTextBlock.Text = "Please enter current credentials for the Windows authenticated user setup to be the administrator for substationSBG. Credentials validated by operating system.";
        ...
        private void RadioButtonWindowsAuthentication_Unchecked(object sender, RoutedEventArgs e)
        {
            ...
            MessageTextBlock.Text = "Please provide the desired credentials for database user setup to be the administrator for substationSBG. Password complexity rules apply.";
