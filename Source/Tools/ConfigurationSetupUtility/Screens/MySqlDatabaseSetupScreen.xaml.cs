    ...
    public partial class MySqlDatabaseSetupScreen : UserControl, IScreen
    {
        ...
        private void InitializeState()
        {
            if (m_state != null)
            {
                ...
                string configFile = FilePath.GetAbsolutePath(App.ApplicationConfig); //"substationSBG.exe.config"

                if (!File.Exists(configFile))
                    configFile = FilePath.GetAbsolutePath(App.ManagerConfig); //"substationSBGManager.exe.config"
