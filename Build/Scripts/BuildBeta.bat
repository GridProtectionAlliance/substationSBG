...
@ECHO OFF
"C:\Program Files (x86)\MSBuild\14.0\Bin\MSBuild.exe" substationSBG.buildproj /p:ForceBuild=true /l:FileLogger,Microsoft.Build.Engine;logfile=substationSBG.output
PAUSE